...
Так как класс `Account` не соответствует реальным счетам, а лишь [является основой для полиморфизма и общей логики](https://proglib.io/p/osnovy-java-vydelyaem-4-raznyh-roli-klassov-2021-09-23) разных счетов, то его следует сделать абстрактным, как и некоторые его методы.
